...
CONFIG_DISCORD_EXPLANATION = "Im nächsten Schritt meldest du dich mit deinem Discord-Account an. So können wir dich direkt unserem Discord-Server hinzufügen und die korrekten Rollen vergeben. Du wirst dazu auf die Discord-Webseite weitergeleitet, und gelangst anschließend wieder zurück auf diese Seite. Keine Angst, wir werden dich ausschließlich zu unserem Pubquiz-Server hinzufügen, und deine ID verwenden, um deine Antworten deinem Team zuzuordnen. Achtung: Ohne Anmeldung in Discord ist die Registrierung ungültig und dein Team muss sich erneut registrieren!"
